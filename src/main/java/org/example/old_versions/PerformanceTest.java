        ...
        for (int numNodes : nodeSizes) {
            for (int threads : threadCounts) {
                try {
                    ...
                    org.example.old_versions.parallel_old.parallelIslands.ShortestPathGAIslandParallel ga = new org.example.old_versions.parallel_old.parallelIslands.ShortestPathGAIslandParallel(graph, threads);
